...
func (v v9KVClient) IsNil(err error) bool {
...
func (s v9LuaScript) Run(ctx context.Context, keys []string, args ...interface{}) (interface{}, error) {
...
func NewGoRedisV9Backend(c *redisv9.Client) Backend {
	...
	return &redisBackend{
		...
		scripts: scripts{
			...
			unlockAndSetResult: v9LuaScript{c: c, s: redisv9.NewScript(luaUnlockAndSetResultSource)},
		},
	}
}
