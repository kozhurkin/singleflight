...
func TestFlightFlow_RunOnce(t *testing.T) {
	var calls int32
...
func TestFlightFlow_WaitAndHits(t *testing.T) {
	f := flight.NewFlightFlow(func() (int, error) {
		return 42, nil
	})
...
func TestFlightFlow_DoneChannel(t *testing.T) {
	f := flight.NewFlightFlow(func() (int, error) {
		time.Sleep(5 * time.Millisecond)
		return 1, nil
	})
...
func TestFlightFlow_Wait_ConcurrentHits(t *testing.T) {
	f := flight.NewFlightFlow(func() (int, error) {
		time.Sleep(5 * time.Millisecond)
		return 7, nil
	})
...
func TestFlightFlow_Then_Success(t *testing.T) {
...
func TestFlightFlow_ThenAny_Success(t *testing.T) {
	base := flight.NewFlightFlow(func() (int, error) {
		return 5, nil
	})
...
func TestFlightFlow_Then_ErrorPropagation(t *testing.T) {
...
func TestFlightFlow_ThenAny_ErrorPropagation(t *testing.T) {
	someErr := errors.New("boom")
	base := flight.NewFlightFlow(func() (int, error) {
		return 0, someErr
	})
...
func TestFlightFlow_Catch(t *testing.T) {
	someErr := errors.New("boom")
	base := flight.NewFlightFlow(func() (int, error) {
		return 0, someErr
	})
...
func TestFlightFlow_Catch_NoErrorPassthrough(t *testing.T) {
	const value = 7
...
func TestFlightFlow_After_CalledAfterCompletion(t *testing.T) {
	f := flight.NewFlightFlow(func() (int, error) {
		time.Sleep(5 * time.Millisecond)
		return 1, nil
	})
...
func TestFlightFlow_After_AlreadyDone(t *testing.T) {
	f := flight.NewFlightFlow(func() (int, error) {
		return 2, nil
	})
...
func TestFlightFlow_StartedFlag(t *testing.T) {
	f := flight.NewFlightFlow(func() (int, error) {
		time.Sleep(5 * time.Millisecond)
		return 1, nil
	})
...
func TestFlightFlow_RunAsyncOnce(t *testing.T) {
	var calls int32
...
func TestFlightFlow_CancelBeforeRun(t *testing.T) {
	var calls int32
...
func TestFlightFlow_CancelAfterRun(t *testing.T) {
	var calls int32
...
func TestFlightFlow_Handle_Success(t *testing.T) {
	base := flight.NewFlightFlow(func() (int, error) {
		return 10, nil
	})
...
func TestFlightFlow_Handle_ErrorRecovery(t *testing.T) {
	someErr := errors.New("boom")
...
func TestFlightFlow_HandleAny_Success(t *testing.T) {
	base := flight.NewFlightFlow(func() (int, error) {
		return 10, nil
	})
...
func TestFlightFlow_HandleAny_ErrorRecovery(t *testing.T) {
	someErr := errors.New("boom")
