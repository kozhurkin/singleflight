...
func (g *Group[K, V]) wrapWithCacheLifecycle(
	key K,
	fn func() (V, error),
) func() (V, error) {
	return func() (V, error) {
...
func (g *Group[K, V]) applyWarmingResult(key K) {
	g.mu.Lock()
	defer g.mu.Unlock()
