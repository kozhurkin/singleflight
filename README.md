...
По идее это тот же [`golang.org/x/sync/singleflight`](https://pkg.go.dev/golang.org/x/sync/singleflight), предназначенный для дедупликации запросов, но с добавлением механизма кеширования.
